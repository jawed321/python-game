...
def firstwindow():
    root.withdraw()
    firstwin=Toplevel()
    label1 = Label(firstwin, text="The Game of\nChances", bg="yellow", fg="red", font=("Comic Sans MS", 22, "bold"),padx=0, pady=0)
    label1.pack()
    # enter name#
    entrname=Label(firstwin, text="Enter Name", bg="green", fg="yellow", font=("Comic Sans MS", 12, "bold"))
    ...
    def second_win(uname):
        ...
        image_spock1= ImageTk.PhotoImage(Image.open("spock.png"))
        image_lizard1=ImageTk.PhotoImage(Image.open("lizard.png"))
        ...
        image_spock2 = ImageTk.PhotoImage(Image.open("spock.png"))
        image_lizard2 = ImageTk.PhotoImage(Image.open("lizard.png"))
        ...
        computer_indi = Label(window, text="computer",font=("Comic Sans MS", 16, "bold"),padx=10, pady=10,bg="green",fg="yellow")
        user_indi1 = Label(window, text=username,font=("Comic Sans MS", 16, "bold"), padx=10, pady=10,bg="green",fg="yellow")
        computer_indi.grid(row=0, column=5)
        user_indi1.grid(row=0, column=1)
        user_indi2 = Label(window, text=username+"=> 0", font=("Comic Sans MS", 16, "bold"), padx=10, pady=10, bg="green",
                           fg="yellow")
        user_indi2.grid(row=6, column=1)
        computer_indi2 = Label(window, text="computer=> 0", font=("Comic Sans MS", 16, "bold"), padx=10, pady=10, bg="green",
                              fg="yellow")
        ...
        def comp_update():
            ...
            def gameover(xyz):
                ...
                def restartfunc():
                    ...
                    win.destroy()
                # restart button
                restartbtn = Button(win, text="Start New Game",width=14,height=2,bg="white",fg="blue",command=lambda: restartfunc())
